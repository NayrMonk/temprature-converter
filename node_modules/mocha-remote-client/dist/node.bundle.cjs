...
(function(root) {
		...
		*/
		...
		var debug = __webpack_require__(720)('mocha:runnable');
		var milliseconds = __webpack_require__(250);
		...
		var Pending = __webpack_require__(642);
		var utils = __webpack_require__(272);
		var debug = __webpack_require__(720)('mocha:runner');
		var Runnable = __webpack_require__(4);
		var Suite = __webpack_require__(461);
		...
		const debug = __webpack_require__(720)('mocha:suite');
		const milliseconds = __webpack_require__(250);
		...
		const debug = require$$2("mocha-remote");
...
const mochaDebug = require$$2('mocha-remote:client');
    ...
    connect() {
        ...
        return new Promise((resolve, reject) => {
            ...
            ws.addEventListener("error", event => {
                ...
                this.emit(exports.ClientEvents.ERROR, error);
            });
